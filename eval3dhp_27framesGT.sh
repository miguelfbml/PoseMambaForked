...
python train_3dhp.py --config configs/pose3d/testing/PoseMamba_train_3dhp_S_27.yaml --evaluate checkpoint/pose3d/PoseMamba_train_3dhp_S_27GT/best_epoch.bin --checkpoint eval/checkpoint_S_27GT
