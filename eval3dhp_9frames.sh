...
python train_3dhp.py --config configs/pose3d/PoseMamba_train_3dhp_S_9.yaml --evaluate checkpoint/pose3d/PoseMamba_train_3dhp_S_9 --checkpoint eval/checkpoint_S_9
