...
#SBATCH --job-name=testPoseMambaS    # Job name
...
python train.py --config checkpoint/pose3d/PoseMamba_S/config.yaml --evaluate checkpoint/pose3d/PoseMamba_S/best_epoch.bin --checkpoint eval/checkpointS