...
Usage:
python 3DestimationPoseMamba27.py
python 3DestimationPoseMamba27.py --camera 0 --conf 0.5
python 3DestimationPoseMamba27.py --show-fps
python 3DestimationPoseMamba27.py --no-viz
"""
...
DEFAULT_POSEMAMBA_CONFIG = os.path.join(PROJECT_ROOT, 'configs', 'pose3d', 'PoseMamba_train_3dhp_S_27.yaml')
DEFAULT_POSEMAMBA_CHECKPOINT = os.path.join(ZDEMO_DIR, 'weights', 'PoseMamba', 'ModelS', 'best_epoch_27.bin')
...
def main():
    ...
    n_frames = int(getattr(posemamba_config, 'n_frames', getattr(posemamba_config, 'maxlen', 27)))
