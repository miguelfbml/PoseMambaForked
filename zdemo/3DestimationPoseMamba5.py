...
Usage:
python 3DestimationPoseMamba5.py
python 3DestimationPoseMamba5.py --camera 0 --conf 0.5
python 3DestimationPoseMamba5.py --show-fps
python 3DestimationPoseMamba5.py --no-viz
"""
...
DEFAULT_POSEMAMBA_CONFIG = os.path.join(PROJECT_ROOT, 'configs', 'pose3d', 'testing', 'notestaug', 'PoseMamba_train_3dhp_S_5.yaml')
DEFAULT_POSEMAMBA_CHECKPOINT = os.path.join(ZDEMO_DIR, 'weights', 'PoseMamba', 'ModelS', 'best_epoch_5.bin')
